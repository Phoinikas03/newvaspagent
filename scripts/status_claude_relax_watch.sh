...
RUNS="$REPO/runs"
SUPERVISOR_SESSION="${RX_WATCH_SUPERVISOR_SESSION:-rxclaudewatch}"
AGENT_SESSION="${RX_TMUX_SESSION:-rxvasp}"
LOCK_DIR="${RX_WATCH_LOCK_DIR:-$RUNS/claude_relax_watch.lock}"
LOCK_PID_FILE="$LOCK_DIR/pid"
LOCK_HEARTBEAT_FILE="$LOCK_DIR/heartbeat"
WATCH_LOG="${RX_WATCH_LOG:-$RUNS/claude_relax_watch.log}"
SUPERVISOR_LOG="${RX_WATCH_SUPERVISOR_LOG:-$RUNS/claude_relax_watch.supervisor.log}"
