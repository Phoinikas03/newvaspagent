...
RUNS="$REPO/runs"
SUPERVISOR_SESSION="${BG_WATCH_SUPERVISOR_SESSION:-bgwatch}"
...
WATCH_LOG="${BG_WATCH_LOG:-$RUNS/codex_bandgap_watch.log}"
SUPERVISOR_LOG="${BG_WATCH_SUPERVISOR_LOG:-$RUNS/codex_bandgap_watch.supervisor.log}"
